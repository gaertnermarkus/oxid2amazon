...
abstract class az_amz_feed
{
    ...
    public static function create($sFeedType, $sDestinationId, $blDryRun = FALSE)
    {
        ...
        require_once getShopBasePath() . "/modules/anzido/oxid2amazon/amazon/feeds/az_amz_" . $sFeedType . '.php';
    ...
    public function getTemporaryExportDir()
    {
        if(!isset($this->_temporaryDir)) {
            ...
            $sExportDir = rtrim($sExportDir, '/\\') . '/' . 'modules/anzido/oxid2amazon/amazon/export';
            #echo $sExportDir;
